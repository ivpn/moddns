...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/profiles/{id}/custom_rule_groups/order": {
            "patch": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "List and ordered group names",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/requests.ReorderProfileCustomRuleGroupsBody"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "requests.ReorderProfileCustomRuleGroupsBody": {
            "type": "object",
            "required": [
                "action",
                "order"
