...
class SubscriptionApi:
    ...
    def api_v1_sub_get(
        ...
        _param = self._api_v1_sub_get_serialize(
    ...
    @validate_call
    def api_v1_sub_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def api_v1_sub_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
