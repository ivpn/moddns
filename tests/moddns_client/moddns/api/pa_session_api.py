...
class PASessionApi:
    ...
    @validate_call
    def api_v1_pasession_add_post(
        self,
        body: Annotated[RequestsPASessionReq, Field(description="Pre-auth session request")],
        ...
        :param body: Pre-auth session request (required)
        :type body: RequestsPASessionReq
        ...
        _param = self._api_v1_pasession_add_post_serialize(
            body=body,
    ...
    @validate_call
    def api_v1_pasession_add_post_with_http_info(
        self,
        body: Annotated[RequestsPASessionReq, Field(description="Pre-auth session request")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v1_pasession_add_post_without_preload_content(
        self,
        body: Annotated[RequestsPASessionReq, Field(description="Pre-auth session request")],
        _request_timeout: Union[
            None,
    ...
    def _api_v1_pasession_add_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/pasession/add',
    ...
    def api_v1_pasession_rotate_put(
        self,
        body: Annotated[RequestsRotatePASessionReq, Field(description="Rotate pre-auth session request")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._api_v1_pasession_rotate_put_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v1_pasession_rotate_put_with_http_info(
        self,
        body: Annotated[RequestsRotatePASessionReq, Field(description="Rotate pre-auth session request")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v1_pasession_rotate_put_without_preload_content(
        self,
        body: Annotated[RequestsRotatePASessionReq, Field(description="Rotate pre-auth session request")],
        _request_timeout: Union[
            None,
    ...
    def _api_v1_pasession_rotate_put_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v1/pasession/rotate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
